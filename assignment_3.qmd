...
Make sure you match your workflow to this organization above, and when you grade your peer, grade them with this setup as well.
...
3b. Next, you are going to iterate over the vector you created above, reading in **each of the csv files**, and then storing the data from each of these files in the i^th^ element of a list that you create for this purpose.
