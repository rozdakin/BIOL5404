...
2)  Learn the core principles of reproducible computational projects.
3)  Practice using R to explore, wrangle, graph, and model realistic (complex) research data.
4)  Learn how to troubleshoot.
5)  Practice learning a new data technique and/or package in R.
