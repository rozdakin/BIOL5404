...
2)  Practice using R to explore, wrangle, graph, and model realistic (complex) research data.
3)  Solve errors in R code (troubleshooting).
4)  Demonstrate the core principles of reproducible computational projects.
5)  Apply (learn to use) a new data technique and/or package in R.
6)  Create an independent data analysis and report that is ready for publishing.
