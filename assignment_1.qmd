...
-   CCreate a new .R script to complete this assignment in your local assignments folder for this course.
...
data$useR <- grepl('R', data$analysisPgrm) # ignore.case = F by default
