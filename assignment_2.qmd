...
1a. Write your OWN function that takes a vector of numeric data, and returns the sample standard deviation (you'll need to know the formula for SD to do this). Use the formula for the ***Sample*** ***SD*** here:

[![](standard-deviation_formula.png){width="527"}](https://www.k2analytics.co.in/wp-content/uploads/2020/05/standard-deviation.png)
