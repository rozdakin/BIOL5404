...
The link above takes you to a folder with previous markdown projects that past were willing to share, for your benefit! They nicely show the diversity and depth of exploratory data analyses. You should be able to download all files for a given project. To get a quick look at one, you could download JUST the html file. Note: you must download (previewing the htmls from within Google Drive doesn't let you view the final formatting).

For A6, you will not yet be creating a "pretty" markdown version. The goal here is to draft your EDA as a regular-old R script, applying tools and concepts that we've been working on all term.
