...
Please note that some of the examples above go to greater lengths than necessary for this course (e.g., because the project is part of the student's primary or thesis research, students often do a lot more than what is needed to fulfill the requirements for this course).
